<?php
  ...
  if(isset($_POST['embeed']))//&&isset($_POST['description'])&&isset($_POST['url'])&&isset($_FILE['image']))
  {

    $query = $pdo->prepare("INSERT INTO video (`code`) VALUES (:code)");
    $query -> execute(array(
        ':code'=>$_POST['embeed']
    ));
...
<body id="page-top">
  ...
  <section class="blog-section">
    <form method="post">
      ...
      <div class="col-xs-6 col-xs-offset-6 clear-fix">Embeed Code:</div><input type="text" name="embeed" class="col-xs-9 col-xs-offset-1" required>
      <div class="col-xs-6 col-xs-offset-5 clear-fix"><input type="submit" class="col-xs-9 col-xs-offset-1" value="Add Video"></div>
    </form>
  </section>
